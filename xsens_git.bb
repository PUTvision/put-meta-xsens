...
SRC_URI = "git://github.com/PPI-PUT/bluespace_ai_xsens_ros_mti_driver;${ROS_BRANCH};protocol=https \
            file://put-xsens-autostart.bash \
            file://put-xsens-autostart.service"
...
do_install:append() {
    ...
    install -d ${D}${bindir}
	install -m 0755 ${WORKDIR}/put-xsens-autostart.bash ${D}${bindir}

	install -d ${D}${systemd_system_unitdir}
	install -m 0644 ${WORKDIR}/put-xsens-autostart.service ${D}${systemd_system_unitdir}
}
...
SYSTEMD_PACKAGES = "${PN}"
SYSTEMD_SERVICE:${PN} = "put-xsens-autostart.service"
